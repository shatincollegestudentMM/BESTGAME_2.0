...
function preload() {
  ...
  BACKGROUND = loadImage("Assets/creat_a_Night_time_themed_HOng_Kong_sky_line_png.png");
  BOX = loadImage("Assets/block.png");
  ...
  SOUND_OUCH = loadSound("Assets/ouch.wav");
    ...
    COIN.resize(20,20);
    LADDER.resize(PIXELS_PER_BLOCK, PIXELS_PER_BLOCK);
    SPIKES.resize(PIXELS_PER_BLOCK, PIXELS_PER_BLOCK);
    STAR.resize(64,64);
